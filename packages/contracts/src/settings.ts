...
export const ClientSettingsSchema = Schema.Struct({
  ...
  // Reveals the collapsed sidebar as an overlay while the pointer rests on the
  // window's left edge. Opt-in: a sidebar that appears on approach is the kind
  // of motion people either want or actively dislike.
  sidebarHoverPeekEnabled: Schema.Boolean.pipe(Schema.withDecodingDefault(Effect.succeed(false))),
...
export const ClientSettingsPatch = Schema.Struct({
  ...
  sidebarHoverPeekEnabled: Schema.optionalKey(Schema.Boolean),
